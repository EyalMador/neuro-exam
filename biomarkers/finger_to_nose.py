...
def extract_finger_to_nose_biomarkers(coords, output_dir, filename, fps=60):
    ...
    filtered_left = filter_by_angle_threshold(left_dist, left_angle, angle_thresh=200)
    filtered_right = filter_by_angle_threshold(right_dist, right_angle, angle_thresh=200)
